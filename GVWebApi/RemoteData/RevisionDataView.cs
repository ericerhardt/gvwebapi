...
namespace GVWebapi.RemoteData
{
    ...
    {
        public Nullable<long> RevisionDataID { get; set; }
        ...
        public Nullable<long> OverageUnderage { get; set; }
        public Nullable<decimal> OverageExpense { get; set; }
        public Nullable<decimal> OverageNoFPR { get; set; }
        public Nullable<decimal> NetSavings { get; set; }
